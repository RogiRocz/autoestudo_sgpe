...
export const prontuarioRegisterPacienteFieldsSchema = prontuarioFieldsSchema.pick({
	aluno_id: true,
	paciente_id: true,
	data_hora: true
})
...
const { aluno_id, paciente_id, data_hora } = prontuarioDefaultValues

export const prontuarioRegisterPacienteDefaultValues = {
	aluno_id, paciente_id, data_hora
}
...
export type ProntuarioRegisterPacienteForms = z.infer<typeof prontuarioRegisterPacienteFieldsSchema>
