...
export class Paciente extends BaseUser implements IAuthenticatable {
    ...
    @ApiProperty({
        example: '12345678901',
        description: 'CPF (apenas 11 números)',
    })
    cpf: string
    ...
    @ApiProperty({
        ...
        example: CLIENTE_PRONTUARIO_STATUS.ATIVO,
        description: 'Status de atividade do paciente no sistema',
    })
    ...
    @ApiProperty({
        description: 'Data da atualização de alguma informação do paciente',
    })
    atualizadoEm: Date
    ...
    @ApiProperty({
        ...
        isArray: true,
        required: false,
        description: 'Prontuários das sessões do paciente',
    })
